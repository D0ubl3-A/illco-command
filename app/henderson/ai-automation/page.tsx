      ...
      <div className="workspace blogWorkspace">
        <nav className="appLandingNav" aria-label="Henderson AI automation navigation">
          ...
          <div>
            ...
            <a className="button secondary" href="/audit-proof">Proof Center</a>
            <a className="button primary" href="/project">Discuss a Workflow</a>
          </div>
        </nav>
        ...
        <section className="panel blogHero">
          <div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 22 }}>
              <a className="button primary" href="/project">Discuss an Automation</a>
        ...
        <section className="panel blogArticle">
          <div className="blogArticleBody" style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <section>
              <span className="blogSectionEyebrow">Proof discipline</span>
              <h2>Public claims should match current evidence</h2>
              <p>
                iLLCo AI separates proposed work from verified public status. Workflows and products should not be described
                as proven, live, licensed, endorsed, or customer-validated unless current evidence supports the claim.
              </p>
              <a className="button secondary" href="/audit-proof">Review the Proof Center</a>
            </section>
            ...
            <section className="blogInternalLinks" aria-labelledby="related-henderson-services">
              <h2 id="related-henderson-services">Related iLLCo AI Resources</h2>
              <div>
                <a href="/henderson/ai-consulting"><strong>AI Consulting Henderson</strong><span>Planning and implementation guidance for Henderson businesses.</span></a>
                <a href="/blog/best-ai-automation-tools-for-small-business"><strong>Best AI Automation Tools for Small Business</strong><span>Choose the stack after identifying the workflow.</span></a>
                <a href="/blog/ai-lead-follow-up-automation-small-business"><strong>AI Lead Follow-Up Automation</strong><span>Go deeper on a revenue-adjacent workflow.</span></a>
              </div>
            </section>
          </div>
        </section>
