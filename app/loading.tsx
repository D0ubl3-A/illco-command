    ...
    <main id="main-content" className="bg-slate-950">
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl rounded-[8px] border border-white/10 bg-white/[0.04] p-6">
          ...
          <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Loading the app catalog.</h1>
          <p className="mt-3 text-sm leading-6 text-slate-400">Preparing Google OAuth, ChatGPT tools, and the live product catalog.</p>
        </div>
      </section>
    </main>
  );
